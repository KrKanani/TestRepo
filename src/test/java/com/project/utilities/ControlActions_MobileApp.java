...
public class ControlActions_MobileApp extends TestBase {
	...
	public static void click(WebElement formName) {
		try {
			waitForVisibility(formName);
			formName.click();
		} catch (Exception ex) {
			throw ex;
	...
	public static WebElement perform_ScrollToElementByXPath(String formName, String string, String formName2) {
