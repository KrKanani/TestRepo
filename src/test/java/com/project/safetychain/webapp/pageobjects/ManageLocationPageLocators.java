...
public class ManageLocationPageLocators {
	...
	public static final String COPY_BTN1 = "//*[@id='copyLocationPopUp']//button[2]";
	public static final String COPY_LOCATION_TXT = "//*[@id='copyLocationPopUp']/div[text()='Copy Location']";
	public static final String SELECT_ALL = "//input[@ng-click='toggleAllResourceTypes()']";
	...
	public static final String ALL_RESOURCE_TYPES_CHK = "//*[@ng-change='resourceTypeToggled()']";
