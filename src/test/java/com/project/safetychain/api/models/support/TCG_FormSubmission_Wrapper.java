...
import com.project.safetychain.api.models.FormSubmissionFlow;
...
public class TCG_FormSubmission_Wrapper extends TestBase {
	...
	FormSubmissionFlow formSubmissionFlow = null;
...
//	@Test(description = "Submit Form ")
	public void API_Form_Submit_Wrapper(FormParams fp) throws InterruptedException {
		...
		// level 2 try for Select One/Multiple and Aggregate formSubmissionFlow
		new GsonBuilder().create();
		boolean submitForm = formSubmissionFlow.createRecord(fp);
		TestValidation.IsTrue(submitForm, "Form named " + fp.FormName + " is Submitted",
				"Could NOT Submit form " + fp.FormName);
