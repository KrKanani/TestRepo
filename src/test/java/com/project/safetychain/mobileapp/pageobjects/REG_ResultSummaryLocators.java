...
public class REG_ResultSummaryLocators {
	...
	public static final String RELATEDDOC = "//android.widget.Button[@text='01.PNG']";
	...
	public static final String RESULTSMRYLINK = "//android.widget.TextView[@text='Results Summary']";
	public static final String CLEARBTNRSUM = "clearButton";
	public static final String SUBMITRS = "submitButton";
	public static final String FROMDATETXT = "//android.widget.TextView[@text='From Date']";
	public static final String TODATETXT = "//android.widget.TextView[@text='To Date']";
	public static final String FORMTXT = "//android.widget.TextView[@text='Form']";
	public static final String BATCHLETTERTXT = "//android.widget.TextView[@text='Batch Letter']";
	public static final String PLUTXT = "//android.widget.TextView[@text='PLU Produced']";

	public static final String FROMDTTXT = "//android.widget.TextView[@text='From Date']//parent::android.widget.LinearLayout//following-sibling::android.widget.RelativeLayout//android.widget.EditText";
	public static final String TODTTXT = "//android.widget.TextView[@text='To Date']//parent::android.widget.LinearLayout//following-sibling::android.widget.RelativeLayout//android.widget.EditText";

	public static final String FORMBOX = "//android.widget.TextView[@text='Form']//parent::android.widget.LinearLayout//following-sibling::android.widget.EditText";
	public static final String BLBOX = "//android.widget.TextView[@text='Batch Letter']//parent::android.widget.LinearLayout//following-sibling::android.widget.EditText";
	public static final String PLUBOX = "//android.widget.TextView[@text='PLU Produced']//parent::android.widget.LinearLayout//following-sibling::android.widget.EditText";

	public static final String CLEARBTNRS = "clearButton";

	public static final String RESULTFILTERHEADER = "headTitle";
	public static final String RSBACKBTN = "ellipsisBtn";

	public static final String FROMDTPICK = "//android.widget.TextView[@text='From Date']//parent::android.widget.LinearLayout//following-sibling::android.widget.RelativeLayout//android.widget.Button";
	public static final String TODTPICK = "//android.widget.TextView[@text='To Date']//parent::android.widget.LinearLayout//following-sibling::android.widget.RelativeLayout//android.widget.Button";
