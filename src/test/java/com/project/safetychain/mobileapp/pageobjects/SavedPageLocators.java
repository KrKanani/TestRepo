...
public class SavedPageLocators {
	...
	public static final String SUBMIT_REPEAT_BTN = "submitRepeatBtn";
	...
	// public static final String DATE_SELECTED =
	// "//android.view.View[contains(@text,'DATE')]";
	...
	public static final String SAVEDWEBFORM = "//*[@id='scs-saved-forms-grid']//tr//td[text()='FORM_NAME']//following-sibling::td[text()='DATE_TIME_STAMP']";
	...
	public static final String MANDATORY_INPUT_FIELD = "//android.widget.TextView[contains(@resource-id,'fieldTitle') and @text='FIELD_NAME *']/../following-sibling::android.widget.RelativeLayout/*[contains(@resource-id,'resultView')]";
	public static final String NOT_MANDATORY_INPUT_FIELD = "//android.widget.TextView[contains(@resource-id,'fieldTitle') and @text='FIELD_NAME']/../following-sibling::android.widget.RelativeLayout/*[contains(@resource-id,'resultView')]";
