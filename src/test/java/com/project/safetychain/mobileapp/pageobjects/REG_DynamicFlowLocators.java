...
public class REG_DynamicFlowLocators {
	...
	public static final String DELETECANCEL = "btnCancel"; // CANCEL
	public static final String DELETEYESBTN = "btnOk"; // YES
	public static final String DISCARDSAVEPOPUP = "btnAutoSave"; // SAVE
	public static final String DISCARDBTN = "btnDiscard"; // DISCARD
